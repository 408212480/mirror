...
$(function () {
    ...
    var user_list = $('#user_list').DataTable({
        ...
        "ajax": function (data, callback, settings) {
            ...
            param.pageIndex = data.start / data.length;

            Request.get('user', param, function (e) {
                if (e.success || data != null) {
                    var resultData = {};
                    resultData.draw = data.draw;
                    resultData.recordsTotal = e.total;
                    resultData.recordsFiltered = e.total;
